...
#         super().__init__()
#         self.dw = nn.Conv3d(dim // 2, dim // 2, kernel_size=3, padding=1, bias=False, groups=dim // 2)
...
class HorNet(nn.Module):
    ...
    def __init__(self, in_chans=1, num_classes=1000,
                 depths=[3, 3, 9, 3], base_dim=32, drop_path_rate=0.,
                 layer_scale_init_value=1e-6, head_init_scale=1.,
                 gnconv=gnconv, block=Block, out_indices=[0, 1, 2, 3, 4],
                 pretrained=None,

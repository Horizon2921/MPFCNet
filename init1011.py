...
class Options():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--images_folder', type=str,
                            default='/home/dluser/dataset/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task55_k/imagesTr')
        parser.add_argument('--labels_folder', type=str,
                            default='/home/dluser/dataset/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task55_k/labelsTr')

        parser.add_argument('--output_folder', type=str, default='/home/dluser/dataset/nnUNetFrame/Pytorch--3D-Medical-Images-Segmentation/result2023/checkpoint')
        ...
        parser.add_argument('--batch_size', type=int, default=4, help='batch size, depends on GPU')
        ...
        parser.add_argument('--out_channels', default=6, type=int,
                            help='Channels of the output, Classes of Segmentation')

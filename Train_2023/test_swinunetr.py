...
def main():
    ...
    # 指定输出路径
    output_folder = '/home/dluser/dataset/nnUNetFrame/Pytorch--3D-Medical-Images-Segmentation/result2023/test/swinunetr'
    ...
    ckpt = torch.load(
        '/home/dluser/dataset/nnUNetFrame/Pytorch--3D-Medical-Images-Segmentation/result2023/checkpoint/best_metric_0305_monai_swinunetr.pth'
    )
